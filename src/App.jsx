...
import AlgorithmCreation from "components/mainpanel/algorithm/algorithmpersistance/AlgorithmCreation";
import AlgorithmEdition from "components/mainpanel/algorithm/algorithmpersistance/AlgorithmEdition";
                ...
                <div className="d-flex flex-row">
                    ...
                    <div className="col container-fluid">
                        <Routes>
                            ...
                            <Route exact path='/algorithm-edition/:id' element={<AlgorithmEdition/>}/>
